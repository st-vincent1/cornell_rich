...
if __name__ == '__main__':
    ...
    """Movie character numbers mapped to character names; 
    normally the code below would be used but we use the Cornell-rich version instead
    ...
    movie_lines = pd.read_csv("cornell_movie_dialogs_corpus/movie_lines.txt",
                              delimiter="\t", encoding="ISO-8859-1", on_bad_lines='skip', header=None)
